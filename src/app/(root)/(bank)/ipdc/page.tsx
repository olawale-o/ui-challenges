...
const Hero = () => {
  return (
    <div className="bg-yellow-400 overflow-hidden relative z-20 h-[772px] after:content-[''] after:absolute after:top-0 after:right-0 after:bg-[#ffeaf5] after:-z-10 after:w-1/2 after:h-[682px]">
      <header className="w-full">
        <div className="flex items-center w-full justify-between px-[135px] pt-4">
          <Link href="/">
            <Image
              src={"/ipdc/ipdc-log.png"}
              width={109}
              height={53}
              alt="IPDC Logo"
            />
          </Link>
          <div className="ml-[96px] mr-[33px] flex basis-[823px] justify-between items-center">
            {navLinks.map((navLink, i) => (
              <Link
                href="/"
                className="text-[#010101] text-xs leading-5 tracking-[2px] font-semibold font-metropolis"
                key={i}
              >
          ...
          <div>
            <button
              type="button"
              aria-label="service"
              className="inline-flex py-2 px-5 bg-[#ed017f] rounded text-white text-xs leading-5 tracking-[2px] font-medium font-metropolis"
            >
              iSERVICE
            </button>
          </div>
      ...
      <div className="h-full ps-[135px] box-border">
        <div className="top-1/2 -translate-y-1/2 absolute z-[100]  box-border">
          <div className="flex flex-col">
            <h1 className="text-[#010101] w-[453px] text-[63px] leading-[68px] font-metropolis font-black">
            ...
            <div className="mt-[38px] flex gap-x-5">
              <button
                type="button"
                className="py-[13px] px-5 text-xs bg-[#ed017f] text-white leading-5 tracking-[2px] font-bold rounded border-[1px]"
              >
                APPLY ONLINE
              </button>
              <button
                type="button"
                className="py-[13px] px-5 text-xs bg-white text-[#ed017f] leading-5 tracking-[2px] font-bold rounded border-[1px]"
              >
                LOAN CALCULATOR
              </button>
            </div>
        ...
        <div className=" slide-container bg-gray-50 w-[905px] absolute right-0">
          <div className="relative slides box-border">
            <div className="slide">
              <figure className="relative aspect-[4/3] box-border w-full bg-green-800">
                <div className="absolute inset-0 h-full w-full">
                  <Image
                    alt="wood"
                    src="/ipdc/family-photo.png"
                    className="block w-full h-full absolute object-cover inset-0"
                    sizes="100vw"
                    fill
                  />
                </div>
          ...
          <div className="slide-dots absolute -translate-y-1/2 top-1/2 right-[60px] flex flex-col justify-between h-[91px] items-center">
            <div className="w-[13px] h-[13px] rounded-full bg-[#F467b2]" />
            <div className="w-2 h-2 rounded-full bg-[#ccc]" />
            <div className="w-2 h-2 rounded-full bg-[#ccc]" />
            <div className="w-2 h-2 rounded-full bg-[#ccc]" />
          </div>
        </div>
        <div className="mt-auto justify-between absolute bottom-[50px] flex">
          <div>
            {" "}
            <div className="inline-flex items-center gap-[11px]">
              ...
              <span className="text-[#010101] tracking-[1px] font-semibold font-metropolis text-[17px] leding-[22px]">
                16519
              </span>
            </div>{" "}
          </div>
          <div className="w-[1px] h-6 bg-[#ccc] mx-[18px]" />
          <div className="flex gap-x-4 justify-self-end">
            {socials.map((social) => (
              <Link href="/" key={social.id} aria-label={social.label}>
                {social.icon}
              </Link>
            ))}
          </div>
